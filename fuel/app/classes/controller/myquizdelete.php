...
class Controller_Myquizdelete extends Controller
{
  public function action_index()
  {
    ...
    try
    {
      ...
      DB::delete('sm_answer')->where('question_id','in',$quiz_id)->execute();
      DB::delete('correct')->where('question_id','in',$quiz_id)->execute();
      DB::delete('incorrect')->where('question_id','in',$quiz_id)->execute();
    }
