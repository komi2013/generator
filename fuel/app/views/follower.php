...
<html>
  <head>
    ...
    <?php } ?>
    <link rel="stylesheet" type="text/css" href="/assets/css/follower.css?ver=1" />
...
<table cellspacing="0" boroder="0" id="header">
  ...
  <td id="center">Follower</td>
  <td class="edge"><img src="<?=$usr_img?>" class="icon"></td>
</table>
