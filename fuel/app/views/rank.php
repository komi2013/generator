...
<html>
  <head>
    ...
    <?php } ?>
    <link rel="stylesheet" type="text/css" href="/assets/css/rank.css?ver=1" />
...
<table id="drawer" cellspacing="1" boroder="0">
  ...
  <tr><td id="this_page"><a href="/rank/">&nbsp;&nbsp;&nbsp;ランク</a></td></tr>
...
<table>
  <tr>
  <td id="tag_td">#<input type="text" placeholder="<?=$tag?>" maxlength="12" id="tag_name">
    <span id="search"><img src="/assets/img/icon/search.jpg" alt="search" class="icon"></span>
  </td>
  </tr>
</table>

<table id="cel">
  <?php foreach($asc_tag_rank as $d){ ?>
    <tr>
      <td class="td_15"><a href="/profile/?u=<?=$d['usr_id']?>"><img src="<?=$d['img']?>" alt="usr" class="icon"></a></td>
      <td class="td_49"><a href="/profile/?u=<?=$d['usr_id']?>"><input type="text" value="<?=$d['name']?>" readonly class="input_txt"></a></td>
      <td class="td_15"><?=$d['count']?></td>
      <td class="td_15"><img src="/assets/img/icon/circle_big.png" alt="correct" class="icon"></td>
    </tr>
  <?php } ?>  
</table>
<?=View::forge('ad')?>
...
<script src="/assets/js/rank.js?ver=1"></script>
