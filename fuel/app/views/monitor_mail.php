...
used disk               ,<?=str_pad($arr_disk[0],6)?>, <?=$arr_disk[1]." \r"?>
vmstat(r) read          ,<?=str_pad($arr_read[0],6)?>, <?=$arr_read[1]." \r"?>
vmstat(r) write         ,<?=str_pad($arr_write[0],6)?>, <?=$arr_write[1]." \r"?>
vmstat(free) freemem    ,<?=str_pad($arr_freemem[0],6)?>, <?=$arr_freemem[1]." \r"?>
