...
<html>
  <head>
    ...
    <?php } ?>
    <link rel="stylesheet" type="text/css" href="/assets/css/search.css?ver=1" />
...
<div id="content">
<table>
  <tr><td class="td_98"><a href="/rank/?tag=<?=$_GET['tag'] ?: ''?>">ランク</a></td></tr>  
</table>
<table>
  <tr>
  <td id="tag_td">#<input type="text" value="<?=$_GET['tag'] ?: ''?>" maxlength="20" id="tag_name"></td>
